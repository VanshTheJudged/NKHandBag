export type MaterialType = 'Synthetic' | 'Jute' | 'Non-woven' | 'Woven' | 'Canvas';
...
export function getMaterialType(product: Product): MaterialType | null {
  ...
  if (m.includes('rexine') || m.includes('faux leather') || m.includes('pu)') || m.includes('chrome') || m.includes('pvc') || m.includes('nylon') || m.includes('polyester')) return 'Synthetic';
  return null;
}
export const MATERIAL_TYPES: MaterialType[] = ['Synthetic', 'Jute', 'Non-woven', 'Woven', 'Canvas'];
...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Everyday Fresh Start Non-Woven Bag Set',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Multicolour non-woven set',
    description: 'A vibrant set of non-woven bags in orange, pink, blue, and green, printed with an "Every Day is a Fresh Start" wheat logo.',
    howItsMade: 'Heat-sealed non-woven fabric available across multiple colourways with a single-colour logo print.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Rust orange non-woven / Leaf logo',
    description: 'A rust-orange non-woven bag for Haqeeq Textiles, printed with a leaf emblem and "Quality You Can Trust" tagline.',
    howItsMade: 'Non-woven fabric body dyed rust orange with a single-colour logo print and tan handles.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Maroon non-woven / Diamond pattern',
    description: 'A maroon non-woven bag for Vaibhavi Collection, printed with a repeating diamond pattern base panel.',
    howItsMade: 'Heat-sealed non-woven fabric with a printed diamond-pattern base panel and matching handles.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    description: 'A deep teal non-woven bag for Qaswa Jewellers, framed with a gold decorative border and black handles.',
    howItsMade: 'Dyed non-woven fabric with a gold-tone border print and stitched black handles.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    description: 'A soft pink non-woven bag for Madhuram Jewellers, printed with a fine repeating floral motif.',
  ...
  {
    slug: 'razwada-jewellery-woven-shopping-bag',
    name: 'Razwada Jewellery Woven Shopping Bag',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'White Synthetic / Blue floral border',
    description: 'A white synthetic-fabric bag for Razwada, framed with a blue floral border pattern and gold logo panel.',
    howItsMade: 'Synthetic fabric body with a printed blue floral border and stitched white handles.',
    materials: ['Synthetic Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Red non-woven / Blue peacock illustration',
    description: 'A red non-woven bag for Anaya Gifts & More, printed with a detailed peacock illustration and blue trim.',
    howItsMade: 'Heat-sealed non-woven fabric with a multicolour peacock print and contrast blue edge trim.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    subCategory: 'Shopping Bag',
    detail: 'Charcoal grey canvas / White floral print',
    description: 'A charcoal grey canvas bag for Ritwika, printed with a white floral motif and "Style with Purpose" tagline.',
    howItsMade: 'Dyed canvas body with a white floral screen print and black webbing handles.',
    materials: ['Cotton Canvas'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Tan & black jute / Leaf logo',
    description: 'A two-tone tan and black jute bag for Green Earth, printed with a leaf emblem and "A Better Tomorrow" tagline.',
    howItsMade: 'Two jute panels stitched together in contrasting tones with a green leaf print and black handles.',
    materials: ['Jute'],
  ...
  {
    slug: 'rashmi-non-woven-shopping-bag',
    name: 'Rashmi Non-Woven Shopping Bag',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Taupe non-woven / Floral logo print',
    description: 'A taupe non-woven bag for Rashmi, printed with a delicate floral emblem and "Elegance Woven Into Style" tagline.',
    howItsMade: 'Non-woven fabric body with a fine floral print and stitched taupe handles.',
    materials: ['Non-woven Fabric'],
  ...
  {
    slug: 'jagdamba-jewellers-woven-shopping-bag',
    name: 'Jagdamba Jewellers Woven Shopping Bag',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Cream woven / Hindi wordmark border',
    description: 'A cream woven bag for Jagdamba Jewellers, framed with a decorative border print and the store name in Hindi.',
    howItsMade: 'Woven fabric body with a printed decorative border and stitched cream handles.',
  ...
  {
    slug: 'tribal-print-non-woven-bag',
    name: 'Tribal Print Non-Woven Bag',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Black & lime non-woven / Tribal pattern',
    description: 'A striking black non-woven bag with a bold lime-green tribal zigzag pattern — graphic and eye-catching.',
    howItsMade: 'Heat-sealed non-woven fabric with an allover lime tribal print and black webbing handles.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Cream jute / Brown trim',
    description: 'A cream jute bag for S R Shanklesha Jewellery, finished with a brown trim panel and gold monogram print.',
    howItsMade: 'Natural jute weave with a brown fabric trim panel, gold-tone print, and stitched brown handles.',
    materials: ['Jute'],
  ...
  },
  {
    ...
    subCategory: 'Shopping Bag',
    description:
      'A compact, vivid blue non-woven bag with a zip closure — practical, eco-friendly, and perfect for everyday carry or gifting.',
    howItsMade:
      'Woven from natural non-woven fibre, dyed a rich blue, and finished with a sturdy zip and contrast handle for durability.',
    materials: ['Non-woven Fabric'],
  ...
  },
  {
    ...
    materials: ['Synthetic', 'Cotton handles'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Ladies Bag',
    detail: 'Blush pink synthetic / Gold print',
    description: 'A blush pink structured pouch-style bag for Raiyaraj Jewellers, printed with the logo in gold.',
    howItsMade: 'Cut and stitched on dyed synthetic with a gold-tone logo print and cream cotton handles.',
    materials: ['Cotton synthetic', 'Cotton handles'],
  ...
  },
  {
    ...
    subCategory: 'Office Bags',
    description:
      'A refined grey non-woven tote-briefcase with warm tan leather handles and trim — a stylish, softer take on the classic office bag.',
    howItsMade:
      'Cotton non-woven body with stitched genuine leather handles and trim, a front zip pocket, and a structured base.',
    materials: ['Cotton Non-Woven', 'Leather Trim'],
  ...
  },
  {
    ...
    subCategory: 'Office Bags',
    description:
      'A structured black non-woven briefcase with tan leather handles and a front slip pocket — a classic silhouette with a heritage-inspired finish.',
    howItsMade:
      'Sturdy non-woven construction with stitched leather top handles, a front utility pocket, and a durable zip closure.',
    materials: ['Cotton Non-Woven', 'Leather Handles'],

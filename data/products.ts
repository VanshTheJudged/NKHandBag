export type MaterialType = 'Nylon' | 'Jute' | 'Non-woven' | 'Woven' | 'Canvas' | 'Rexine';
...
export function getMaterialType(product: Product): MaterialType | null {
  ...
  if (m.includes('rexine') || m.includes('faux leather') || m.includes('pu)') || m.includes('chrome') || m.includes('pvc')) return 'Rexine';
  if (m.includes('canvas')) return 'Canvas';
  if (m.includes('woven')) return 'Woven';
  if (m.includes('nylon') || m.includes('polyester')) return 'Nylon';
  return null;
}
export const MATERIAL_TYPES: MaterialType[] = ['Nylon', 'Jute', 'Non-woven', 'Woven', 'Canvas', 'Rexine'];
...
export const products: Product[] = [
  ...
  },
  {
    ...
    howItsMade: 'Heat-sealed non-woven fabric with an all-over checkered print and matching red webbing handles.',
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Woven fabric / Contrast trim',
    ...
    howItsMade: 'Woven fabric panels stitched with contrast coloured side trim and matching fabric handles.',
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Cream woven / Hindi wordmark',
    description: 'A cream woven-fabric bag for Ganpati Jewellers, printed with a fine diamond pattern and the store name in Hindi.',
    howItsMade: 'Woven fabric body with an allover diamond print, a printed wordmark panel, and cream handles.',
    materials: ['Woven Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Rust orange woven / Leaf logo',
    description: 'A rust-orange woven bag for Haqeeq Textiles, printed with a leaf emblem and "Quality You Can Trust" tagline.',
    howItsMade: 'Woven fabric body dyed rust orange with a single-colour logo print and tan handles.',
    materials: ['Woven Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Grey woven / White motif print',
    description: 'A grey woven bag for Shubh Creations, printed with a fine white repeat motif and a boxed logo badge.',
    howItsMade: 'Woven fabric body with an allover tonal print and a printed logo badge, finished with grey handles.',
    materials: ['Woven Fabric'],
  ...
  {
    slug: 'golden-trellis-woven-shopping-bag',
    name: 'Golden Trellis Woven Shopping Bag',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Cream & yellow woven / Trellis pattern',
    description: 'A two-tone woven bag pairing a cream trellis-print top with a solid yellow base panel.',
    howItsMade: 'Woven fabric body with a printed trellis pattern and a contrast dyed base panel.',
    materials: ['Woven Fabric'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Teal jute / Gold border print',
    description: 'A deep teal jute bag for Qaswa Jewellers, framed with a gold decorative border and black handles.',
    howItsMade: 'Dyed jute weave with a gold-tone border print and stitched black handles.',
    materials: ['Jute'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Tan jute / Black trim border',
    description: 'A tan jute bag for Aadhya Collections, framed with a black trim border and leaf accent print.',
    howItsMade: 'Natural jute weave edged in black trim, with a printed leaf motif and black handles.',
    materials: ['Jute'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Orange jute / Hindi wordmark',
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Yellow jute / Green leaf logo',
    description: 'A vibrant yellow jute bag for Pragati Weaves, printed with a green leaf emblem and "Timeless Tradition" tagline.',
    howItsMade: 'Dyed jute weave with a green logo print and stitched jute handles.',
    materials: ['Jute'],
  ...
  },
  {
    ...
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'White woven / Blue floral border',
    description: 'A white woven-fabric bag for Razwada, framed with a blue floral border pattern and gold logo panel.',
    howItsMade: 'Woven fabric body with a printed blue floral border and stitched white handles.',
    materials: ['Woven Fabric'],
  ...
  },
  {
    ...
    howItsMade: 'Woven fabric body with gold-tone printed border panels and stitched black handles.',
    materials: ['Woven Fabric'],
  ...
  {
    slug: 'rashmi-woven-shopping-bag',
    name: 'Rashmi Woven Shopping Bag',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Taupe woven / Floral logo print',
    description: 'A taupe woven bag for Rashmi, printed with a delicate floral emblem and "Elegance Woven Into Style" tagline.',
    howItsMade: 'Woven fabric body with a fine floral print and stitched taupe handles.',
    materials: ['Woven Fabric'],
  ...
  },
  {
    ...
    howItsMade: 'Woven fabric body edged in navy trim, with a printed catalogue-style panel and navy handles.',
    materials: ['Woven Fabric'],
  ...
  },
  {
    ...
    materials: ['Non-woven Fabric', 'PVC'],
    images: ['/products/bags/shopping-bags/b63.jpg'],
    customisable: ['Colour', 'Handles', 'Logo Print', 'Stitching'],
    materialType: 'Non-woven',
  },
  {
    slug: 'thank-you-non-woven-bag-set',
    name: 'Thank You Non-Woven Bag Set',
    category: 'Bags',
    subCategory: 'Shopping Bag',
    detail: 'Multicolour non-woven set',
    description: 'A set of non-woven bags in black, green, blue, and orange, printed with a "Thank You For Choosing Us" wordmark.',
    howItsMade: 'Heat-sealed non-woven fabric available across multiple colourways with a single-colour logo print and die-cut handles.',
    materials: ['Non-woven Fabric'],
